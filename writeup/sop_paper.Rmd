...
```{r wr_rt,  fig.pos = "t", fig.cap="Reaction times for two-alternative forced-choice word recognition paradigms. Each circle shows an experiment, with colors indicating papers;  areas are scaled by the number of participants in each study. Dotted line shows adult reaction time. Dashed lines show best-fitting Kail function (black) and a generic loess smoothing function (blue)."}
...
```{r wr_acc, fig.pos = "t", fig.cap="Accuracies for word recognition paradigms. Circles show experiments, with colors indicating papers;  areas are scaled by the number of participants in each study. Dotted line shows chance, and dashed lines show best-fitting half-logit function (black) and loess (blue)."}
...
```{r gf_rt, fig.pos = "t", fig.cap="Reaction times for gaze following. Plotting conventions are as above. Results for pointing are shown with a black border."}
...
```{r gf_acc, fig.pos = "t", fig.cap="Accuracies for social cue following. Plotting conventions are as above."}
...
```{r full_sim, fig.pos = "t", fig.height = 2.5, fig.cap="Simulation results using meta-analytic parameters."}
n.sims <- 1000
ages <- seq(0, 5, .1)
